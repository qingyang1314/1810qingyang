  ...
  <body>
    <div class="maincont">
     ...
     <div id="sliderA" class="slider">
      <img src="http://upload.tp5.com/{{$data->goods_img}}"  width="150px" /><img src="http://upload.tp5.com/{{$data->goods_img}}"  width="150px" />
      <img src="http://upload.tp5.com/{{$data->goods_img}}"  width="150px" />
      <img src="http://upload.tp5.com/{{$data->goods_img}}"  width="150px" />
      </div><!--sliderA/-->
     <table class="jia-len">
      <tr>
