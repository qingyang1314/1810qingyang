    ...
    <div class="maincont">
     ...
     <div class="dingdanlist" onClick="window.location.href='address.html'">
      <table>
       ...
       <tr>
        <td class="dingimg" width="15%"><img src="http://upload.tp5.com/{{$data->goods_img}}" /></td>
        <td width="50%">
       ...
       <tr>
        <th colspan="3"><strong class="orange">¥{{$data->shop_price}}</strong></th>
       </tr>


       <tr>
        <td class="dingimg" width="75%" colspan="2">商品金额</td>
        <td align="right"><strong class="orange">¥{{$data->shop_price}}</strong></td>
       </tr>
      </table>
     </div><!--dingdanlist/-->
    ...
    <div class="gwcpiao">
     <table>
      <tr>
       ...
       <td width="50%">总计：<strong class="orange">¥{{$data->shop_price}}</strong></td>
       <td width="40%"><a href="success{{$data->goods_id}}" class="jiesuan">提交订单</a></td>
      </tr>
     </table>
    </div><!--gwcpiao/-->
    </div><!--maincont-->
